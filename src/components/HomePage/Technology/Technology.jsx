    ...
    <div className="technology-wrapper">
      ...
      <div className="tech-segment">
        <div className="tech-info">
          ...
          <p className="tech-p">Our spacecraft is equipped with cutting-edge technology, designed to withstand the harsh conditions of interstellar travel. From advanced propulsion systems to state-of-the-art life support, every aspect of our vessel is engineered for efficiency and safety.</p>

          <div className="our-scientist">
            <div className="scientist" id="scientist1">
              <h3 className="h-scien">Piere Zix</h3>
              <p className="p-scien">Chief Engineer, Zix is responsible for the design and maintenance of our spacecraft's propulsion systems.
                                His expertise in advanced propulsion technologies has enabled us to reach previously inaccessible regions of
                                the galaxy.</p>
              <img className="scientist-working" src={technology.scientist1} alt="Scientist 1"/>
            </div>
            ...
            <div className="scientist" id="scientist2">
              ...
              <p className="p-scien">Our chief scientist, Han, is a renowned expert in exoplanetary geology
                                ...
                                systems.</p>
              <img className="scientist-working" src={technology.scientist2} alt="Scientist 2"/>
            </div>
          </div>

          <div className="suits">
            <img className="suit" src={technology.spaceSuit1} alt="Suit 1" />
            <img className="suit" src={technology.spaceSuit2} alt="Suit 2" />
            <img className="suit" src={technology.spaceSuit3} alt="Suit 3" />
          </div>

          <p className="universe-logo">Universe TourX</p>
        </div>
      </div>
    </div>
  );
