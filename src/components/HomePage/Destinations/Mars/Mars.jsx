  ...
  return (
    <div className="destination-div">
      <div className="video-destination">
        <video id="destination-video" src={PLANETS[2].promoVideo.video5} autoPlay loop muted playsInline></video>
      </div>
        ...
        <div className="destination-info mars-segment">
          ...
          <div className='mars-text'>
            <div className="destination-promo-mars-1">
              <video className="two-promo-vid" id="mars-video-1" src={PLANETS[2].promoVideo.video1} autoPlay loop muted playsInline></video>
            ...
            <div className="destination-promo-mars-1">
              ...
              <video className="two-promo-vid" id="mars-video-2" src={PLANETS[2].promoVideo.video3} autoPlay loop muted playsInline></video>
            </div>
          ...
          <div className="destination-promo-mars-2">
            <video className="two-promo-vid" id="mars-video-3" src={PLANETS[2].promoVideo.video2} autoPlay loop muted playsInline></video>
            <video className="two-promo-vid" id="mars-video-4" src={PLANETS[2].promoVideo.video4} autoPlay loop muted playsInline></video>
          </div>
